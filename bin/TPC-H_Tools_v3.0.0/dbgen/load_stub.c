...
int hd_part(FILE* f) {
    ...
    if (!count++) printf("No header has been defined for the part table\n");
...
int ld_part(part_t* pp, int mode) {
    ...
    if (!count++) printf("No load routine has been defined for the part table\n");
...
int hd_supp(FILE* f) {
    ...
    if (!count++) printf("No header has been defined for the supplier table\n");
...
int hd_order(FILE* f) {
    ...
    if (!count++) printf("No header has been defined for the order table\n");
...
int hd_line(FILE* f) {
    ...
    if (!count++) printf("No header has been defined for the lineitem table\n");
...
int hd_nation(FILE* f) {
    ...
    if (!count++) printf("No header has been defined for the nation table\n");
...
int hd_region(FILE* f) {
    ...
    if (!count++) printf("No header has been defined for the region table\n");
...
int ld_region(code_t* cp, int mode) {
    ...
    if (!count++) printf("%s %s\n", "No load routine has been defined", "for the region table");
